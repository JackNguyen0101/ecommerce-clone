...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final isFavorite = userProvider.user.wishlist.contains(widget.product.id);
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      if (isFavorite) {
                        ...
                        userProvider.removeFromWishlist(widget.product.id!);
                      } else {
                        productDetailsServices.addToWishlist(
                          context: context,
                          product: widget.product,
                        );
                        userProvider.addToWishlist(widget.product.id!);
                      }
                    },
                  ),
                ],
